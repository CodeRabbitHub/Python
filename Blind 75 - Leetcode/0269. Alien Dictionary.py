...
# the alien language's dictionary, where the strings in words are sorted lexicographically
# by the rules of this new language. Return a string of the unique letters in the new alien
# language sorted in lexicographically increasing order by the new language's rules. If
